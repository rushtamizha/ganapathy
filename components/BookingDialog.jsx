...
// import {
//   Car, MapPin, Calendar, Clock, Phone, User, CheckCircle2, Sparkles,
// } from 'lucide-react'
...
//     e.preventDefault()
//     setSubmitting(true)
//     // Simulated confirmation (frontend-only)
//     await new Promise(r => setTimeout(r, 900))
//     setSubmitting(false)
//     onOpenChange(false)
//     toast.success('Booking Request Received!', {
//       description: `We'll call you in 2 minutes to confirm your ${vehicle?.name || 'ride'}.`,
...
//       <DialogContent className="max-w-lg bg-white border-amber-100">
//         <DialogHeader>
//           <div className="flex items-center gap-2 mb-1 text-amber-600">
//             <Sparkles className="w-4 h-4" />
//             <span className="text-xs font-semibold tracking-wider uppercase">Instant Confirmation</span>
//           </div>
//           <DialogTitle className="text-2xl">
//             Book {vehicle?.name || 'Your Cab'}
//           </DialogTitle>
//           <DialogDescription>
//             Fill in the details below. Our team will call you in under 2 minutes.
//           </DialogDescription>
//         </DialogHeader>
...
//               <Label htmlFor="name" className="text-xs"><User className="inline w-3 h-3 mr-1" />Full Name</Label>
//               <Input id="name" required placeholder="John Doe" className="h-10" />
//             </div>
//             <div className="space-y-1.5">
//               <Label htmlFor="phone" className="text-xs"><Phone className="inline w-3 h-3 mr-1" />Mobile</Label>
//               <Input id="phone" required type="tel" placeholder="+91 98765 43210" className="h-10" />
//             </div>
//           </div>
//           <div className="space-y-1.5">
//             <Label htmlFor="from" className="text-xs"><MapPin className="inline w-3 h-3 mr-1" />Pickup Location</Label>
//             <Input id="from" required placeholder="e.g. Koramangala, Bangalore" className="h-10" />
//           </div>
//           <div className="space-y-1.5">
//             <Label htmlFor="to" className="text-xs"><MapPin className="inline w-3 h-3 mr-1" />Drop Location</Label>
//             <Input id="to" required placeholder="e.g. Kempegowda Airport (BLR)" className="h-10" />
//           </div>
//           <div className="grid grid-cols-2 gap-3">
//             <div className="space-y-1.5">
//               <Label htmlFor="date" className="text-xs"><Calendar className="inline w-3 h-3 mr-1" />Pickup Date</Label>
//               <Input id="date" required type="date" className="h-10" />
//             </div>
//             <div className="space-y-1.5">
//               <Label htmlFor="time" className="text-xs"><Clock className="inline w-3 h-3 mr-1" />Pickup Time</Label>
//               <Input id="time" required type="time" className="h-10" />
//             </div>
//           </div>
//           <div className="space-y-1.5">
//             <Label htmlFor="notes" className="text-xs">Special Requests (optional)</Label>
//             <Textarea id="notes" placeholder="Child seat, extra luggage, etc." className="min-h-[60px]" />
//           </div>

//           <div className="flex items-center justify-between px-3 py-2 border rounded-lg bg-amber-50 border-amber-200">
//             <div className="flex items-center gap-2 text-sm">
//               <Car className="w-4 h-4 text-amber-600" />
//               <span className="font-medium">{vehicle?.name || 'Vehicle'}</span>
//             </div>
//             {vehicle?.fare ? (
//               <div className="text-sm font-bold text-slate-900">
//                 {typeof vehicle.fare === 'number' && vehicle.fare > 100
//                   ? `₹${vehicle.fare.toLocaleString('en-IN')}.00`
//                   : `₹${vehicle.fare}.00/km`}
//               </div>
//             ) : null}
//           </div>
...
//             className="w-full font-semibold h-11 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-900">
